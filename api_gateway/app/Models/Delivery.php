...
class Delivery extends Model
{
    ...
    public function deliveryProcessorLog(): HasOne
    {
        $deliveryProcessor = new $this->deliveryProcessor->name();
        return $this->hasOne($deliveryProcessor::class);
    }

    public function process(): void
    {
        logger()->info('### PROCESSING DELIVERY ###', ['externalId' => $this->external_id]);
        (new $this->deliveryProcessor->name)->processDelivery($this);
    }
